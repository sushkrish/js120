...
Computer.prototype.constuctor = Computer;
Computer.choices = ['rock', 'paper', 'scissors'];
Computer.prototype.choose = function() {
  let randomIndex = Math.floor(Math.random() * Computer.choices.length);
  this.move = Computer.choices[randomIndex];
};
